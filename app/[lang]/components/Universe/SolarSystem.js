    ...
    <div className="relative w-64 h-64 sm:w-80 sm:h-80 mx-auto mb-6 sm:mb-8 group z-20 mt-16">\
      ...
      <div className="absolute inset-0 z-10">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          animate-[mercury_4s_linear_infinite]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          animate-[venus_6s_linear_infinite]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          animate-[earth_8s_linear_infinite]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          animate-[mars_10s_linear_infinite]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          animate-[jupiter_12s_linear_infinite]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          animate-[saturn_14s_linear_infinite]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          animate-[uranus_16s_linear_infinite]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          animate-[neptune_18s_linear_infinite]">
